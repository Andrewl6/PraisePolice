...
package com.freedomhi.praisepolice.recognition;

import android.support.annotation.NonNull;
import android.util.Log;

import com.freedomhi.praisepolice.utils.FrameMetadata;
...
public class TextRecognitionProcessor {
	...
	private OnTextDetectedListener listener;
	...
	protected void onSuccess( @NonNull FirebaseVisionText results, @NonNull FrameMetadata frameMetadata, @NonNull GraphicOverlay graphicOverlay) {
		...
		if(listener != null) {
			listener.onNumberDetected(textList);
		}
	}
	...
	public void setListener(OnTextDetectedListener listener) {
		this.listener = listener;
	}

	
	public interface OnTextDetectedListener {
		public void onNumberDetected(ArrayList<String> numberStringList);
	}
}
